...
void ofApp::setup(){
    ...
    ofBackground(0);
    mySound.load("Ikola-Permissions.mp3");
    mySound.play();
    image.load("silppu_leikelty.png");
   // pic.load("silppu_tausta.jpg");
    //image.resize(200, 135);
    bool vertical = true;
    ...
    mesh.enableColors();
    gui.setup();
    gui.add(uiAmount.set("noise", 0,0,100));
    ...
    float connectionDistance = 30; // ****TEST
    ...
    float intensityThreshold = 5.0; // LOW with texture pics
...
void ofApp::draw(){
    ...
    ofPushMatrix();
    //ofRotateDeg(180);
        ofTranslate(-ofGetWidth()/2-1400, -ofGetHeight()/2-500);
        mesh.draw();
    ofPopMatrix();
 ...
 /*
    ofPushMatrix();
    //ofRotateDeg(180);
        ofTranslate(-ofGetWidth(), -ofGetHeight(), 100);
        mesh.draw();
    ofPopMatrix();

    ofPushMatrix();
    //ofRotateDeg(180);
        ofTranslate(-ofGetWidth(), -ofGetHeight(), 200);
        mesh.draw();
    ofPopMatrix();
